...
public class finalCase2 extends TestBaseRapor {
    HomePage homePage ;
    ProductPage productPage ;
    ShoppingCartPage shoppingCartPage ;

    private static final Logger logger = LogManager.getLogger(finalCase2.class.getName());
    ...
    public void kullaniciGirişiYapilmadanSepeteEkleme() throws IOException {
        ...
        extentTest = extentReports.createTest("finalCase2", "Kullanıcı girişi yapılmadan belirtilen ürünü sepete ekleme");
        ...
        CommonMethods.getScreenshot("GirisYapilmadan_AnaSayfa");
